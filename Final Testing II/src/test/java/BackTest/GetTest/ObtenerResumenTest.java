...
public class ObtenerResumenTest {

    @Test
    @Tag("All")
    @Tag("GetTest")
    @Tag("BackTest")
    public void Get_ResumenCuentas() {
        ...
        Response resGet = RestAssured.get("http://parabank.parasoft.com/parabank/services/bank/customers/" + customerId + "/accounts");
